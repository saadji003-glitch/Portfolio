...
export const certificatesList: Certificate[] = [
  {
    ...
    pdfUrl: '/certificates/saad-khan-prompt-engineering-certificate.pdf',
    pdfName: 'saad-khan-prompt-engineering-certificate.pdf',
  },
  {
    ...
    pdfUrl: '/certificates/saad-khan-employability-skills-certificate.pdf',
    pdfName: 'saad-khan-employability-skills-certificate.pdf',
  },
  {
    ...
    studentId: 'STU69032200998f51761812992',
    certificateId: '4ce99c6948f05c29f633',
    grade: 'A',
    gradeLabel: 'Very Good (70-79%)',
    gradeColor: 'from-cyan-500 to-blue-600',
    summary: 'Official 8-week virtual internship in Python Fullstack Development. Developed hands-on projects utilizing Python backend structures, web routing, database integration, and end-to-end full stack workflows.',
    skillsLearned: [
      'Python Programming & Scripting',
      'Full Stack Web Architecture',
      'Backend APIs & Routing',
      'Database Design & Queries',
      'Frontend-Backend Integration',
      'Project Build & Deployment',
    ],
    pdfUrl: '/certificates/saad-khan-python-fullstack-certificate.pdf',
    pdfName: 'saad-khan-python-fullstack-certificate.pdf',
  },
  {
    ...
    grade: 'C',
    gradeLabel: 'Passed Internship Grade (50-59%)',
    gradeColor: 'from-amber-400 to-orange-500',
    summary: 'Hands-on 8-week virtual internship in Java Full Stack development with project. Gained practical experience in Object-Oriented Java, Web API architectures, relational backend concepts, and project deployment.',
    skillsLearned: [
    ...
    pdfUrl: '/certificates/saad-khan-java-fullstack-certificate.pdf',
    pdfName: 'saad-khan-java-fullstack-certificate.pdf',
  },
  {
    id: 'cert-deloitte-tech',
    title: 'Technology Job Simulation',
    issuer: 'Deloitte',
    supportedBy: 'Issued by Forage',
    period: 'September 2026',
    duration: 'Completed September 7th, 2026',
    studentId: '6a9eca591c45172ff2ec4f36',
    certificateId: '6a9ecb4b39a1f8e666c72999',
    grade: 'Completed',
    gradeLabel: 'Verified Completion',
    gradeColor: 'from-emerald-500 to-green-600',
    summary: 'Completed practical tasks in Coding and Development through the Deloitte Technology Job Simulation hosted on Forage. Authenticated under Chief Human Resources Officer Tina McCreery.',
    skillsLearned: [
    ...
    pdfUrl: '/certificates/saad-khan-deloitte-technology-job-simulation.pdf',
    pdfName: 'saad-khan-deloitte-technology-job-simulation.pdf',
  },
];
